...
class DigitalTwinAnalysis:
    def __init__(self, population_df: pd.DataFrame, initial_df: pd.DataFrame, cfg: SimulationConfig):
        ...
        # Agents
        self.q = QLearningAgent(alpha=cfg.alpha, gamma=cfg.gamma, epsilon=cfg.epsilon)
        ...
        # Timings
        self.timings = {"Q": 0.0, "SARSA": 0.0, "Greedy": 0.0, "HC": 0.0, "overall_wall_seconds": 0.0}
        ...
        for day in range(self.cfg.days):
            for u in self.population:
                ...
                if u.dropped_out:
                    ...
                    self.timings["Q"] += time.perf_counter() - t0
